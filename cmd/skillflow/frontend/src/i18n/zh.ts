export const zh = {
  ...
  'dashboard.autoPushTitle': '自动推送目标工具',
  'dashboard.autoPushDesc': '新添加到「我的skills」的 Skill 会自动复制到选中的工具。之后取消勾选也不会删除已经推送过去的内容。',
  'dashboard.autoPushEmpty': '当前没有已启用的工具，先去设置里启用工具后再使用自动推送。',
