export const en = {
  ...
  'settings.repoScanMaxDepth': 'Remote Repo Recursive Scan Depth',
  'settings.repoScanMaxDepthHint': 'Maximum recursion depth for starred-repo and GitHub-install scanning. Default is 5; values are clamped to 1-20 to avoid pathological nested trees.',
