export const en = {
  ...
  'toolSkills.searchPlaceholder': 'Search Skills in agent...',
  ...
  'settings.statusPageMyTools': 'My Agents',
  'settings.statusPageMyToolsDesc': 'Per-agent push-path and scan-path cards.',
  'settings.statusPagePushToTool': 'Push to Agent',
  'settings.statusPagePushToToolDesc': 'Library cards shown while selecting what to push.',
  'settings.statusPagePullFromTool': 'Pull from Agent',
  'settings.statusPagePullFromToolDesc': 'Scanned agent skills shown before importing.',
  ...
  'settings.repoScanMaxDepthHint': 'Maximum recursion depth for local agent scans, starred repos, and GitHub-install scanning. Default is 5; values are clamped to 1-20 to avoid pathological nested trees.',
