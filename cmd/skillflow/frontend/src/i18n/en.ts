export const en = {
  ...
  'dashboard.autoPushDesc': 'New skills added to My Skills are copied to the selected tools automatically. Turning a tool off here does not remove anything already synced there.',
  'dashboard.autoPushEmpty': 'No enabled tools available. Enable one in Settings to use auto sync.',
