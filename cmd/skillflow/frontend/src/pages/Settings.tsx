...
import { OpenFolderDialog, GetAppVersion, GetLogDir, OpenLogDir, GetAppDataDir, OpenAppDataDir } from '../../wailsjs/go/main/App'
...
import { GetConfig, SaveConfig, ListCloudProviders, CheckAppUpdateAndNotify, TestProxyConnection } from '../lib/backend'
