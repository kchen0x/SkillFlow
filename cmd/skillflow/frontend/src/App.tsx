...
import { DownloadAppUpdate, ApplyAppUpdate, OpenGitBackupDir, OpenURL } from '../wailsjs/go/main/App'
...
import { GetGitConflictPending, ResolveGitConflict, SetSkippedUpdateVersion } from './lib/backend'
