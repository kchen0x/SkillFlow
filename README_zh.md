...
| **跨工具同步** | 推送或拉取 Skills 到/从 Claude Code、OpenCode、Codex、Gemini CLI、OpenClaw 及自定义工具；“我的skills”可持久化配置新增 Skill 的自动推送目标工具，推送页默认进入“手动选择”，拉取页默认全部不选并新增“选择未导入”复选框，已推送工具会以紧凑图标列表显示并支持悬浮查看完整列表 |
