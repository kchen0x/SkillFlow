...
- `backup` is extracted under `core/backup/app`, `domain`, and `infra`
...
- the old `core/skill`, `core/prompt`, `core/sync`, `core/git`, and flat `core/backup` packages have been removed
